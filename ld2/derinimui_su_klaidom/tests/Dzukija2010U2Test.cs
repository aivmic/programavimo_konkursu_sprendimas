...
[TestFixture]
public class Dzukija2010U2Test
{
	[Test]
	public void TestSomething()
	{
		//take inputs and outputs for the solution
		var inputs = Dzukija2010U2.TestData.Inputs;
		var outputs = Dzukija2010U2.TestData.Outputs;
		...
		inouts
			...
			.ForEach(it => {
				...
				var task = new Dzukija2010U2();
				var output = task.Run(input);
				for (var i = 0; i < expectedOutput.ats.Length; i++)
				{
					Assert.That(output.ats[i] == expectedOutput.ats[i], $"Wrong answer");
				}
